...
SYSTEM_PROMPT = (
    ...
    "рынок].\n"
    "ПРАВИЛА ДЛЯ КАРТИНКИ: Промпт СТРОГО НА АНГЛИЙСКОМ, 30-50 слов. Сначала "
    "определи тональность и тему новости, затем подбери визуальный стиль, "
    "который ей соответствует, а не один и тот же шаблон каждый раз. "
    "Примеры соответствий: взлом/скам/эксплойт -> напряжённый, мрачный, "
    "тревожные тени; регуляторные новости/суд/закон -> строгий деловой стиль, "
    "холодные тона, здания судов или банков; институциональное партнёрство/ "
    "инвестиции -> чистый корпоративный стиль, стекло и сталь, светлые тона; "
    "рост рынка/ралли -> динамичная светлая композиция, растущие графики, "
    "тёплый свет; падение рынка/паника -> холодные мрачные тона, разбитые "
    "элементы, штормовая атмосфера; технологии/блокчейн-апдейты -> "
    "футуристичный минимализм, чистые линии, мягкое свечение. Всегда: "
